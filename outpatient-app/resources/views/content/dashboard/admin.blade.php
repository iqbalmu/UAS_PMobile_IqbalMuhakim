    ...
    <div class="col-lg-8 mb-4 order-0">
        <div class="card">
            <div class="d-flex align-items-end row">
                <div class="col-sm-7">
                    <div class="card-body">
                        <h5 class="card-title text-primary">Welcome {{ $user->nama }} 🎉</h5>
                        <p class="mb-4">
            ...
            <div class="col-lg-6 col-md-12 col-6 mb-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <span class="fw-medium d-block mb-1">Poliklink</span>
            ...
            <div class="col-6 col-md-2 mb-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <span class="fw-medium d-block mb-1">Apoteker</span>
            ...
            <div class="col-6 col-md-2 mb-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <span class="fw-medium d-block mb-1">Admisi</span>
                        <h3 class="card-title mb-2">$14,857</h3>
                        <small class="text-success fw-medium"><i class="bx bx-up-arrow-alt"></i> +28.14%</small>
                    </div>
                </div>
